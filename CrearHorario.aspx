<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Saph.Master" CodeFile="CrearHorario.aspx.vb" Inherits="FWCrearHorario" %>
   
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
   <div id="splash"><p><span>crear horario</span></p> 
    </div>
    <br />
    ...
    <asp:TextBox ID="TxtCorreoElectronico" runat="server" Width="300px" tooltip="Recibirá la URL para administrar el horario en esta dirección.No supone ningún tipo de registro"></asp:TextBox>
    <br />

	<br />
    <br />
    <asp:Button ID="BtnSiguiente" runat="server" Text="Siguiente" CssClass="boton-accion" />
    <br />
    <br />
</asp:Content>
